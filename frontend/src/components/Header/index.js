      ...
      <AppBar
        ...
        <Toolbar className="app-toolbar" disableGutters={false}>
          ...
          <Link className="app-logo mr-2 d-none d-sm-block" to="/">
            <img src={require("assets/images/logo2.png")} alt="Apiux" title="Apiux"/>
          </Link>
            ...
            <li className="list-inline-item app-tour">
              <Dropdown
                ...
                <DropdownToggle
                  ...
                  data-toggle="dropdown">
                  <IconButton className="icon-btn">
                    <i style={{"color": "#2c2e3e"}} className="zmdi zmdi-notifications-none icon-alert animated infinite wobble"/>
                  </IconButton>
                </DropdownToggle>
